...
## Files
- `prompts/ut-logic-assess-agent.prompt.md`: Orchestrator prompt for the agent.
...
- `templates/ut-logic-assess-invocation-template.md`: Copy/paste request templates with placeholders for repo path, report mode, and output file.
- `example-runs/standard-report.sample.md`: Example of expected standard report output.
- `example-runs/detailed-report.sample.md`: Example of expected detailed report output.

## Quick Start
1. Open `templates/ut-logic-assess-invocation-template.md`.
